...
public class Bullet : MonoBehaviourPunCallbacks
{
    ...
    private void OnCollisionEnter(Collision collision) // When Bullet gets a collision with an object
    {
        ...
        else
        {
            ...
            {
                collision.transform.root.gameObject.GetPhotonView().RPC("GetDamage", RpcTarget.OthersBuffered, (int)100f);
            ...
            {
                collision.transform.root.gameObject.GetPhotonView().RPC("GetDamage", RpcTarget.OthersBuffered, (int)Random.Range(70f, 99f));
            ...
            {
                collision.transform.root.gameObject.GetPhotonView().RPC("GetDamage", RpcTarget.OthersBuffered, (int)Random.Range(10f, 50f));
            ...
            {
                collision.transform.root.gameObject.GetPhotonView().RPC("GetDamage", RpcTarget.OthersBuffered, (int)Random.Range(20f, 60f));
